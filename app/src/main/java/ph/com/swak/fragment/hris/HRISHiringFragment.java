 ...
 */
public class HRISHiringFragment extends BaseFragment {
    ...
    public HRISHiringFragment() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_hris_hiring, container, false);
        ...
        LineChart lineChart = chartUtil.initLineChart(R.id.lineHRISHiring, xVals, "Hiring Frequency");
